    ...
    <div className={cn("flex flex-col gap-6 md:grid md:grid-cols-2 md:items-center md:gap-16", className)} {...props}>
      ...
      <Card className="ring-0 shadow-none md:ring-1 md:ring-foreground/10 md:shadow-sm">
        <CardHeader className="grid place-items-center md:justify-start md:text-left">
          ...
          {/* PC版のみ表示するシンプルな見出し */}
          <CardTitle className="hidden md:block text-xl">ログイン</CardTitle>
        </CardHeader>
        <CardContent>
          <form
            ...
            <FieldGroup>
              ...
              <Field>
                <div className="flex items-center">
                  ...
                  <a href="#" className="ml-auto hidden md:inline-block text-sm text-primary underline-offset-4 hover:underline">
                    お忘れですか？
                  </a>
                </div>
              ...
              <Field>
                ...
                <Button className="py-6" variant="outline" type="button" onClick={handleGoogleLogin}>
                  Google で ログイン
                </Button>
